...
export class Client {
  ...
  async accountCreate(input) {
    ...
    console.log("accountCreate store ", store)
    ...
    console.log("accountCreate did ", account?.result?.account?.did)
  ...
  async createCid(did) {
    ...
    const account =
      ...
      // fetch(`https://auth.etherland.world/api/v0/volume/push/${cid}`, requestOptions)
